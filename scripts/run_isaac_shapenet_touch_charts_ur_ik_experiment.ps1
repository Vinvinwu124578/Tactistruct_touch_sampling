...
$collectorScript = Join-Path $scriptRoot "collect_shapenet_touch_charts_isaac_ur_ik_experiment.py"
...
Write-Host ""
Write-Host "==== Isaac ShapeNet TacTip touch charts (UR IK experiment) ===="
