...
POSE_LABEL_NAMES = ["pose_1", "pose_2", "pose_3", "pose_4", "pose_5", "pose_6"]
SHEAR_LABEL_NAMES = ["move_1", "move_2", "move_3", "move_4", "move_5", "move_6"]

OBJECT_POSE_LABEL_NAMES = ["object_x", "object_y", "object_z", "object_Rx", "object_Ry", "object_Rz"]


def read_target_df_csv(
    og_target_file,
    shuffle_data,
    save_dir=None
):
    ...
    if save_dir:  # copy the target csv in real to sim
